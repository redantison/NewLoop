...
def run_cli(config: Dict[str, Any], n_quarters: int = 80) -> None:
    ...
    legend = [
        ...
        ("UIS,F,G,I",  "UIS bundle (per-household): UIS UIS_F UIS_G UIS_I, one-space separated") ,
        ...
        ("AvgInc","Average income proxy per household = wages/HH + UIS (display-currency; excludes dividends)") ,

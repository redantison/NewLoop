...
PARAMETER_CONTROLS: tuple[ParamControl, ...] = (
    ...
    ParamControl(
        ...
        1.0,
        0.01,
        help_text="Share of Unmodeled Sector deposits recycled into FUND each quarter once the trust is active.",
    ),
    ParamControl(
        ("ums_drain_to_gov_share",),
        "UMS Drain Share To GOV",
        STARTUP_SECTION,
        "float",
        0.0,
        1.0,
        0.01,
        help_text="Share of each recycled UMS flow routed to GOV instead of FUND once the trust is active.",
    ),
    ParamControl(
